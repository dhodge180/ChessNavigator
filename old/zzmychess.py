...
PIECEY: PieceType = 9
PIECEZ: PieceType = 10
PIECE_TYPES: List[PieceType] = [PAWN, KNIGHT, BISHOP, ROOK, QUEEN, KING, GRASSHOPPER, PIECEX, PIECEY, PIECEZ]
PIECE_SYMBOLS = [None, "p", "n", "b", "r", "q", "k", "g", "x", "y", "z"]
PIECE_NAMES = [None, "pawn", "knight", "bishop", "rook", "queen", "king", "grasshopper", "piecex", "piecey", "piecez"]
...
class Piece:
    ...
    #     import chessf.svg
    #     return chessf.svg.piece(self, size=45)
...
class BaseBoard:
    ...
    def _clear_board(self) -> None:
        ...
        self.piecexs = BB_EMPTY
        self.pieceys = BB_EMPTY
        self.piecezs = BB_EMPTY
    ...
    def pieces_mask(self, piece_type: PieceType, color: Color) -> Bitboard:
        ...
        elif piece_type == PIECEX:
            bb = self.piecexs
        elif piece_type == PIECEY:
            bb = self.pieceys
        elif piece_type == PIECEZ:
            bb = self.piecezs
        else:
    ...
    def piece_type_at(self, square: Square) -> Optional[PieceType]:
        ...
        if not self.occupied & mask:
            ...
            return GRASSHOPPER
        elif self.piecexs & mask:
            return PIECEX
        elif self.pieceys & mask:
            return PIECEY
        elif self.piecezs & mask:
            return PIECEZ
        else:
            return KING
    ...
    def pin(self, color: Color, square: Square) -> SquareSet:
        ...
        >>> import chessf
        >>>
        >>> board = chessf.Board("rnb1k2r/ppp2ppp/5n2/3q4/1b1P4/2N5/PP3PPP/R1BQKBNR w KQkq - 3 7")
        >>> board.is_pinned(chessf.WHITE, chessf.C3)
        True
        >>> direction = board.pin(chessf.WHITE, chessf.C3)
        >>> direction
    ...
    # def _repr_svg_(self) -> str:
    #     import chessf.svg
    #     return chessf.svg.board(board=self, size=400)
    ...
    def from_chess960_pos(cls: Type[BaseBoardT], scharnagl: int) -> BaseBoardT:
        ...
        >>> import random
        >>>
        >>> board = chessf.Board.from_chess960_pos(random.randint(0, 959))
        """
        board = cls.empty()
...
class Board(BaseBoard):
    ...
    def legal_moves(self) -> LegalMoveGenerator:
        ...
        True
        >>> move = chessf.Move.from_uci("g1f3")
        ...
        for from_square in scan_reversed(capturers):
            ...
            for to_square in scan_reversed(targets):
                if square_rank(to_square) in [0, 7]:
                    #yield Move(from_square, to_square, PIECEX)
                    #yield Move(from_square, to_square, PIECEY)
                    #yield Move(from_square, to_square, PIECEZ)
...
class SquareSet:
    ...
    >>> import chessf
    >>>
    >>> squares = chessf.SquareSet([chessf.A8, chessf.A1])
    >>> squares
    SquareSet(0x0100_0000_0000_0001)

    >>> squares = chessf.SquareSet(chessf.BB_A8 | chessf.BB_RANK_1)
    >>> squares
    ...
    # def _repr_svg_(self) -> str:
    #     import chessf.svg
    #     return chessf.svg.board(squares=self, size=390)
    ...
    def ray(cls, a: Square, b: Square) -> SquareSet:
        ...
        >>> import chessf
        >>>
        >>> print(chessf.SquareSet.ray(chessf.E2, chessf.B5))
        . . . . . . . .
        . . . . . . . .
        1 . . . . . . .
        . 1 . . . . . .
    ...
    def between(cls, a: Square, b: Square) -> SquareSet:
        ...
        >>> import chessf
        >>>
        >>> print(chessf.SquareSet.between(chessf.E2, chessf.B5))
        . . . . . . . .
        . . . . . . . .
        . . . . . . . .
        . . . . . . . .
    ...
    def from_square(cls, square: Square) -> SquareSet:
        ...
        >>> import chessf
        >>>
        >>> chessf.SquareSet.from_square(chessf.A1) == chessf.BB_A1
        True
        """
