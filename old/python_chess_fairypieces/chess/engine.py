...
class InfoDict(TypedDict, total=False):
    ...
    tbhits: int
    multipv: int
    currmove: chessf.Move
    currmovenumber: int
    hashfull: int
    cpuload: int
    refutation: Dict[chessf.Move, List[chessf.Move]]
    currline: Dict[int, List[chessf.Move]]
    ebf: float
    wdl: PovWdl
    string: str
...
class PlayResult:
    ...
    move: Optional[chessf.Move]
    """The best move according to the engine, or ``None``."""

    ponder: Optional[chessf.Move]
...
class Score(abc.ABC):
    ...
    >>> from chessf.engine import Cp, Mate, MateGiven
    >>>
...
class Protocol(asyncio.SubprocessProtocol, metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    async def play(self, board: chessf.Board, limit: Limit, *, game: object = None, info: Info = INFO_NONE, ponder: bool = False, draw_offered: bool = False, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}, opponent: Optional[Opponent] = None) -> PlayResult:
        """
        Plays a position.
    ...
    @typing.overload
    async def analyse(self, board: chessf.Board, limit: Limit, *, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> InfoDict: ...
    @typing.overload
    async def analyse(self, board: chessf.Board, limit: Limit, *, multipv: int, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> List[InfoDict]: ...
    @typing.overload
    async def analyse(self, board: chessf.Board, limit: Limit, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> Union[List[InfoDict], InfoDict]: ...
    async def analyse(self, board: chessf.Board, limit: Limit, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> Union[List[InfoDict], InfoDict]:
        """
    ...
    @abc.abstractmethod
    async def analysis(self, board: chessf.Board, limit: Optional[Limit] = None, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> AnalysisResult:
        """
    ...
    @abc.abstractmethod
    async def send_game_result(self, board: chessf.Board, winner: Optional[Color] = None, game_ending: Optional[str] = None, game_complete: bool = True) -> None:
        """
...
class UciProtocol(Protocol):
    ...
    def __init__(self) -> None:
        ...
        self.id = {}
        self.board = chessf.Board()
        self.game: object = None
        self.first_game = True
        self.may_ponderhit: Optional[chessf.Board] = None
    ...
    def _position(self, board: chessf.Board) -> None:
        ...
        if uci_variant == "chess" and fen == chessf.STARTING_FEN:
    ...
    def _go(self, limit: Limit, *, root_moves: Optional[Iterable[chessf.Move]] = None, ponder: bool = False, infinite: bool = False) -> None:
        builder = ["go"]
        if ponder:
    ...
    async def play(self, board: chessf.Board, limit: Limit, *, game: object = None, info: Info = INFO_NONE, ponder: bool = False, draw_offered: bool = False, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}, opponent: Optional[Opponent] = None) -> PlayResult:
        ...
        class UciPlayCommand(BaseCommand[PlayResult]):
            ...
            def start(self) -> None:
                self.info: InfoDict = {}
                self.pondering: Optional[chessf.Board] = None
                ...
                if self.pondering:
                    ...
                    if ponder and best.move and best.ponder:
                        ...
                        if ponder_limit.white_clock is not None:
                            ...
                            if self.pondering.turn == chessf.WHITE:
                        ...
                        if ponder_limit.black_clock is not None:
                            ...
                            if self.pondering.turn == chessf.BLACK:
...
def _create_variation_line(root_board: chessf.Board, line: str) -> tuple[list[chessf.Move], str]:
    board = root_board.copy(stack=False)
    currline: list[chessf.Move] = []
    while True:
...
def _parse_uci_info(arg: str, root_board: chessf.Board, selector: Info = INFO_ALL) -> InfoDict:
    info: InfoDict = {}
    if not selector:
        return info
    ...
    while remaining_line:
        ...
        if parameter == "string":
            ...
            try:
                ...
                info["currmove"] = chessf.Move.from_uci(current_move)
            except (ValueError, IndexError):
...
def _parse_uci_bestmove(board: chessf.Board, args: str) -> BestMove:
    tokens = args.split()
...
class XBoardProtocol(Protocol):
    ...
    def _new(self, board: chessf.Board, game: object, options: ConfigMapping, opponent: Optional[Opponent] = None) -> None:
        ...
        if new_game:
            ...
            fen = root.fen(shredder=board.chess960, en_passant="fen")
            if variant != "normal" or fen != chessf.STARTING_FEN or board.chess960:
    ...
    async def analysis(self, board: chessf.Board, limit: Optional[Limit] = None, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> AnalysisResult:
        ...
        class XBoardAnalysisCommand(BaseCommand[AnalysisResult]):
            ...
            def start(self) -> None:
                self.stopped = False
                self.best_move: Optional[chessf.Move] = None
                self.analysis = AnalysisResult(stop=lambda: self.cancel())
        ...
        class XBoardGameResultCommand(BaseCommand[None]):
            ...
            def start(self) -> None:
                ...
                if not game_complete:
                    ...
                    result = "1-0" if winner == chessf.WHITE else "0-1" if winner == chessf.BLACK else "1/2-1/2"
                    ending = game_ending or ""
                elif outcome is not None and outcome.winner is not None:
                    result = outcome.result()
                    winning_color = "White" if outcome.winner == chessf.WHITE else "Black"
                    is_checkmate = outcome.termination == chessf.Termination.CHECKMATE
...
def _parse_xboard_post(line: str, root_board: chessf.Board, selector: Info = INFO_ALL) -> InfoDict:
...
class BestMove:
    ...
    def __init__(self, move: Optional[chessf.Move], ponder: Optional[chessf.Move]):
        self.move = move
        self.ponder = ponder
...
class SimpleEngine:
    ...
    *timeout* seconds longer than expected (unless *timeout* is ``None``).
    ...
    def play(self, board: chessf.Board, limit: Limit, *, game: object = None, info: Info = INFO_NONE, ponder: bool = False, draw_offered: bool = False, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}, opponent: Optional[Opponent] = None) -> PlayResult:
        with self._not_shut_down():
            coro = asyncio.wait_for(
    ...
    @typing.overload
    def analyse(self, board: chessf.Board, limit: Limit, *, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> InfoDict: ...
    @typing.overload
    def analyse(self, board: chessf.Board, limit: Limit, *, multipv: int, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> List[InfoDict]: ...
    @typing.overload
    def analyse(self, board: chessf.Board, limit: Limit, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> Union[InfoDict, List[InfoDict]]: ...
    def analyse(self, board: chessf.Board, limit: Limit, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> Union[InfoDict, List[InfoDict]]:
        with self._not_shut_down():
            coro = asyncio.wait_for(
    ...
    def analysis(self, board: chessf.Board, limit: Optional[Limit] = None, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chessf.Move]] = None, options: ConfigMapping = {}) -> SimpleAnalysisResult:
        with self._not_shut_down():
            coro = asyncio.wait_for(
    ...
    def send_game_result(self, board: chessf.Board, winner: Optional[Color] = None, game_ending: Optional[str] = None, game_complete: bool = True) -> None:
        with self._not_shut_down():
