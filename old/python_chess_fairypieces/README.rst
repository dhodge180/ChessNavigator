...
.. code:: python
    ...
    >>> import chessf
        ...
        >>> board.legal_moves  # doctest: +ELLIPSIS
        <LegalMoveGenerator at ... (Nh3, Nf3, Nc3, Na3, h3, g3, f3, e3, d3, c3, ...)>
        >>> chessf.Move.from_uci("a8a1") in board.legal_moves
        False
  ...
  .. code:: python
      ...
      * Reads and writes PGNs. Supports headers, comments, NAGs and a tree of
        variations.
            ...
            >>> book = chessf.polyglot.open_reader("data/polyglot/performance.bin")
...
* Probe Syzygy endgame tablebases (DTZ, WDL).
  ...
  .. code:: python
      ...
      * Communicate with UCI/XBoard engines. Based on
            ...
            >>> tablebase = chessf.syzygy.open_tablebase("data/syzygy/regular")
...
* Communicate with UCI/XBoard engines. Based on ``asyncio``.
  ...
  .. code:: python
      ...
      >>> import chessf.engine
            ...
            >>> engine = chessf.engine.SimpleEngine.popen_uci("stockfish")
            ...
            >>> board = chessf.Board("1k1r4/pp1b1R2/3q2pp/4p3/2B5/4Q3/PPP2B2/2K5 b - - 0 1")
            >>> limit = chess.engine.Limit(time=2.0)
            >>> engine.play(board, limit)  # doctest: +ELLIPSIS
            <PlayResult at ... (move=d6d1, ponder=c1d1, info={...}, draw_offered=False, resigned=False)>
